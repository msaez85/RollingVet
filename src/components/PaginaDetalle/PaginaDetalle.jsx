...
const planes = [
  {
    ...
    imagen: "https://i.postimg.cc/tRt2nHqX/Captura-de-pantalla-2023-08-14-14-01-08.png",
  ...
  },
  {
    ...
    imagen: "https://i.postimg.cc/3RScwnyH/Captura-de-pantalla-2023-08-14-14-47-38.png",
  ...
  },
  {
    ...
    imagen: "https://i.postimg.cc/xdLxK9cg/Captura-de-pantalla-2023-08-14-14-44-03.png",
      ...
      <main data-aos="fade-up" className="main">
        ...
        <div className="detalle container-fluid  justify-content-center align-items-start">
          ...
          <div className="descripcion-detalle container-fluid d-flex flex-column justify-content-start align-items-center">
            <h2 style={{color:"#0D1347"}}className="fw-bold fs-2 text-center mb-5">
              {plan.titulo}
            </h2>
